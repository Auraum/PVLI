...
class Match extends Phaser.Scene {
    ...
    create() {
        ...
        this.player1 = new Player(this, 100, 500, this.cursors1, this.weak, this.strong, this.jump, 'player1', this.sensors);
        this.player2 = new Player(this, 1240, 500, this.cursors2, this.weak2, this.strong2, this.jump2, 'player2', this.sensors);
